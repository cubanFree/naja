...
export default function SearchBarProtected({ isMobile, isExpanded, onToggle = () => { }, onSearch = () => { } }) {
                    ...
                    >
                        <div className="relative flex-1">
                            ...
                            <Input
                                ...
                                className="px-4 py-2 pl-10 dark:bg-zinc-800 dark:text-gray-100 focus-visible:ring-0"
